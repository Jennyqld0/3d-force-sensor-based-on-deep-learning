...
import models.modules.ghost2net as ghost2net
import models.modules.ghostnet as ghostnet
import models.modules.resnext as resnext
import models.modules.resnet as resnet
import models.modules.vit as vit
import models.modules.resnet_mutile as resnet_mut
import models.modules.resnet_double as resnet_dou
import models.modules.resnextgoust as resnextgoust
import models.modules.resgoust as resgoust
import models.modules.vgggoust as vgggoust
import models.modules.vggnet as vggnet
...
def define_G(opt):
    ...
    elif which_model == 'resnet18': #force
      #  print('ok')
        netG = resnet.resnet18()
      #  print(netG  )
    elif which_model == 'resnet_dou': #force
      #  print('ok')
        netG = resnet_dou.resnet18()
      #  print(netG  )
    elif which_model == 'vit': #force
      #  print('ok')
        netG = vit.vit_base_patch16_205()
      #  print(netG  )
    elif which_model == 'ghostnet': #force
      #  print('ok')
        netG = ghostnet.ghostnet()              
    elif which_model == 'resgoust18': #force
      #  print('ok')
        netG = resgoust.resgoust18()
      #  print(netG  )
    elif which_model == 'resnet_mut': #force
      #  print('ok')
        netG = resnet_mut.resnet18()
      #  print(netG  )
    elif which_model == 'resnext': #force
      #  print('ok')
        netG = resnext.resnext50()
      #  print(netG  )
    elif which_model == 'resnextgoust': #force
      #  print('ok')
        netG = resnextgoust.resnext50()
      #  print(netG  )                      
    elif which_model == 'vgggoust': #force
      #  print('ok')
        netG = vgggoust.VGG16()
      #  print(netG  )
    elif which_model == 'vggnet': #force
      #  print('ok')
        netG = vggnet.VGG16()
      #  print(netG  )
    else:
