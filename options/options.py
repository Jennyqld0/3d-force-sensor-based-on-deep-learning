...
def parse(opt_path, is_train=True):
    ...
    for phase, dataset in opt['datasets'].items():
        ...
        dataset['phase'] = phase
        is_lmdb = False
        if 'dataroot_image' in dataset and dataset['dataroot_image'] is not None:
            dataset['dataroot_image'] = os.path.expanduser(dataset['dataroot_image'])
            if dataset['dataroot_image'].endswith('lmdb'):
                is_lmdb = True
        if 'dataroot_image_bg' in dataset and dataset['dataroot_image_bg'] is not None:
            dataset['dataroot_image_bg'] = os.path.expanduser(dataset['dataroot_image_bg'])
